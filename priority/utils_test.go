...
func TestPickUpMinNonFatalHandlersQuantity(t *testing.T) {
	quantity := PickUpMinNonFatalHandlersQuantity([]uint{70, 20, 10}, FairDivider, 6)
	require.Equal(t, uint(3), quantity)

	quantity = PickUpMinNonFatalHandlersQuantity([]uint{70, 20, 10}, RateDivider, 8)
	require.Equal(t, uint(6), quantity)
}

func TestPickUpMaxNonFatalHandlersQuantity(t *testing.T) {
	quantity := PickUpMaxNonFatalHandlersQuantity([]uint{70, 20, 10}, FairDivider, 6)
	require.Equal(t, uint(6), quantity)

	quantity = PickUpMaxNonFatalHandlersQuantity([]uint{70, 20, 10}, RateDivider, 8)
...
func TestPickUpMinSuitableHandlersQuantity(t *testing.T) {
	quantity := PickUpMinSuitableHandlersQuantity([]uint{70, 20, 10}, FairDivider, 5, 10)
	require.Equal(t, uint(0), quantity)

	quantity = PickUpMinSuitableHandlersQuantity([]uint{70, 20, 10}, FairDivider, 1000, 10)
	require.Equal(t, uint(6), quantity)

	quantity = PickUpMinSuitableHandlersQuantity([]uint{70, 20, 10}, RateDivider, 21, 10)
	require.Equal(t, uint(0), quantity)

	quantity = PickUpMinSuitableHandlersQuantity([]uint{70, 20, 10}, RateDivider, 1000, 10)
	require.Equal(t, uint(22), quantity)
}

func TestPickUpMaxSuitableHandlersQuantity(t *testing.T) {
	quantity := PickUpMaxSuitableHandlersQuantity([]uint{70, 20, 10}, FairDivider, 5, 10)
	require.Equal(t, uint(0), quantity)

	quantity = PickUpMaxSuitableHandlersQuantity([]uint{70, 20, 10}, FairDivider, 7, 10)
	require.Equal(t, uint(6), quantity)

	quantity = PickUpMaxSuitableHandlersQuantity([]uint{70, 20, 10}, FairDivider, 1000, 10)
	require.Equal(t, uint(1000), quantity)

	quantity = PickUpMaxSuitableHandlersQuantity([]uint{70, 20, 10}, RateDivider, 21, 10)
	require.Equal(t, uint(0), quantity)

	quantity = PickUpMaxSuitableHandlersQuantity([]uint{70, 20, 10}, RateDivider, 23, 10)
	require.Equal(t, uint(22), quantity)

	quantity = PickUpMaxSuitableHandlersQuantity([]uint{70, 20, 10}, RateDivider, 1000, 10)
	require.Equal(t, uint(1000), quantity)
}
